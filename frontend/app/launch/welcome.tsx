...
export default function WelcomeScreen() {
    ...
    return (
        ...
        >
            <SafeAreaView className="flex-1 bg-[#E95322]">
                <View className="flex-1 items-center justify-center px-8">
                    <View className="mb-12">
                        <Yellow_Logo />
                    </View>

                    <Text className="text-[#F8F8F8] text-base text-center leading-6 mb-16 px-4">
                    ...
                    <View className="w-full gap-y-4">
                        <TouchableOpacity
                            ...
                            className="bg-[#F5CB58] h-14 rounded-full items-center justify-center active:bg-primary-dark"
                        >
                            <Text className="text-[#E95322] text-lg font-bold">Log In</Text>
                        </TouchableOpacity>

                        <TouchableOpacity
                            onPress={() => handleAuthNavigation("signup")}
                            className="bg-[#F3E9B5] h-14 rounded-full items-center justify-center active:bg-primary-dark"
                        >
