            ...
            <SafeAreaView className="flex-1 bg-secondary-base">
                <View className="flex-1 items-center justify-center px-8">
                    ...
                    <View className="w-full gap-y-4">
                        ...
                        >
                            <Text className="text-secondary-base text-lg font-bold">Log In</Text>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            ...
                            className="bg-primary-base h-14 rounded-full items-center justify-center active:bg-primary-dark"
                        >
                            <Text className="text-secondary-base text-lg font-bold">Sign Up</Text>
                        </TouchableOpacity>
                    </View>

                    <TouchableOpacity onPress={() => router.replace("/(main)/(tabs)/Home")} className="mt-6">
                        <Text className="text-primary-light text-sm">Continue as Guest</Text>
                    </TouchableOpacity>
                </View>
            </SafeAreaView>
        </Animated.View>
