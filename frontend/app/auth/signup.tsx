      ...
      <View className="flex-1 bg-white rounded-t-3xl px-4 py-4 justify-between">
        <View>
          ...
          <View className="mb-3">
            ...
            <View className="h-[45px] bg-Yellow_2 rounded-xl flex-row items-center justify-between px-3">
              ...
              <TouchableOpacity onPress={() => setShowPassword(!showPassword)}>
                {showPassword ? <Eye size={20} color="#E95322" /> : <EyeOff size={20} color="#E95322" />}
              </TouchableOpacity>
            </View>
          </View>
          ...
          <Text className="text-gray-500 text-center text-sm mb-1">
            ...
            <Text className="text-orange-500 underline" onPress={handleTermsPress}>Terms of Use</Text>{" "}
            and{" "}
            <Text className="text-orange-500 underline" onPress={handlePrivacyPress}>Privacy Policy</Text>.
          </Text>
          ...
          <View className="items-center mb-1">
            <ButtonComponent
              ...
              loading={loading} // NOTE: show loading while processing signup
            />
          </View>
          ...
          <View className="items-center mb-1">
            ...
            <SocialLoginButtons /> {/* NOTE: Social login buttons component */}
          </View>
        </View>
