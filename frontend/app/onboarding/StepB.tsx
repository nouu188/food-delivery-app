...
import { Image2, PaymentIcon } from "@/svgs/SVGOnboarding";
...
const StepB = () => {
  ...
  const slideAnim = useRef(new Animated.Value(50)).current; // dịch chuyển theo X từ 50px
  ...
  const handleNext = () => {
    ...
    router.replace("/onboarding/StepC"); // chuyển sang màn StepC
  };
