...
import { ActivityIndicator, Alert, Clipboard, Image, RefreshControl, ScrollView, Text, TouchableOpacity, View } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import { Feather } from '@expo/vector-icons';
import { MapPin, CreditCard, Wallet, DollarSign, Gift, Phone, Clock, Copy, Package, Truck, Navigation, Star } from 'lucide-react-native';
          ...
          <>
            ...
            >
                      ...
                      return (
                        <View key={step.status} className="flex-row mb-4 last:mb-0">
                          ...
                          <View className="flex-1 pt-1">
                            ...
                            {isActive && (
                              <Text className="text-[#6B7280] text-xs mt-0.5">In Progress...</Text>
                            )}
                          </View>
                        </View>
                      );
                ...
                >
                  <View className="flex-row items-center justify-between">
                    <View className="flex-1">
                      ...
                      <Text className="text-[#070707] font-bold text-lg">{order.restaurant_name}</Text>
                    </View>
                    <TouchableOpacity
              ...
              >
                ...
                {order.voucher_code && (
                  <View className="flex-row items-center pt-3 border-t border-gray-100">
                    ...
                    <View className="flex-1 ml-3">
                      <Text className="text-[#6B7280] text-xs font-medium mb-1">VOUCHER APPLIED</Text>
                      <Text className="text-[#10B981] font-bold text-base">{order.voucher_code}</Text>
                    </View>
                    {order.discount_amount > 0 && (
                      <Text className="text-[#10B981] font-bold text-lg">-${order.discount_amount}</Text>
                    )}
                  </View>
                )}
              </View>
              ...
              {order.special_instructions && (
                <View className="bg-[#FFF5D6] rounded-2xl p-4 mb-6">
                  <Text className="text-[#070707] font-semibold text-sm mb-2">Special Instructions</Text>
              ...
              <View className="bg-[#FFF5D6] rounded-2xl p-5 mb-6">
                ...
                <View className="border-t border-orange-200 pt-4 mt-2">
                  <View className="flex-row justify-between items-center">
                    ...
                    <Text className="text-2xl font-bold text-[#E95322]">
                      ${order.total_amount}
                    </Text>
                  </View>
                </View>
