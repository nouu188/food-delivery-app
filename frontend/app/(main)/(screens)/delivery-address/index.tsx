...
export default function DeliveryAddressScreen() {
    ...
    const { addresses, selectedAddressId, setSelectedAddress, fetchAddresses, deleteAddress, isLoading } =
        useAddressStore();
            ...
            <View className="flex-1 bg-white rounded-t-3xl px-6 pt-6">
                {isLoading && !isRefreshing ? (
                    ...
                    <ScrollView
                        ...
                        refreshControl={
                            <RefreshControl refreshing={isRefreshing} onRefresh={handleRefresh} tintColor="#E95322" />
                        }
                    >
                        {addresses &&
                                                        ...
                                                        <View className="flex-row items-center">
                                                            ...
                                                            {a.is_default && (
                                                                <View className="ml-2 px-2 py-0.5 rounded bg-orange-100">
                                                                    <Text className="text-[#E95322] text-xs font-medium">
                                                                        Default
                                                                    </Text>
                                                                </View>
                                                            )}
