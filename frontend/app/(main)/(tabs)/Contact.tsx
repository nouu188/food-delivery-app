...
export default function HelpScreen() {
  ...
  const categories: Category[] = [
    { id: "all", name: "All", icon: <HelpCircle size={20} color={`${selectedCategory === "all" ? "#FFFFFF" : "#E95322"}`} />, color: "#FFE3D6" },
  ...
  const socialLinks = [
    { icon: <Facebook size={24} color="#1877F2" />, name: "Facebook", url: "http://facebook.com/notoncebuttwice188" },
    { icon: <Twitter size={24} color="#1DA1F2" />, name: "Twitter", url: "https://twitter.com/foodapp" },
    { icon: <Instagram size={24} color="#E4405F" />, name: "Instagram", url: "https://www.instagram.com/notonce_buttwice/" },
  ];
              ...
              >
                {categories.map((category) => (
                  <TouchableOpacity
                    ...
                    className={`mr-3 px-5 py-3 rounded-full flex-row items-center ${selectedCategory === category.id ? 'bg-[#E95322]' : 'bg-[#F9FAFB]'
                      }`}
                    style={{
                  ...
                  >
                    ...
                    <Text className={`font-semibold ${selectedCategory === category.id ? 'text-white' : 'text-[#070707]'
                      }`}>
                      {category.name}
                    </Text>
                  </TouchableOpacity>
            ...
            {!showContactForm ? (
              <View className="border-2 border-[#E95322] rounded-3xl  bg-[#fff7f4] mb-6">
                ...
                >
                  ...
                  <Text className="text-[#E95322] font-bold text-base ml-2 py-4">Send Us a Message</Text>
                </TouchableOpacity>
              </View>
            ) : (
