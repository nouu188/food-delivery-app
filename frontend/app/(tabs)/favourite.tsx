...
const initialFavorites: Item[] = [
    { id: 1, name: 'Chicken Curry', price: 18.0, image: bestSeller.BS1, liked: true },
    ...
    { id: 4, name: 'Mexican Appetizer', price: 10.0, image: bestSeller.BS4, liked: true },
    ...
    { id: 8, name: 'Chocolate Cake', price: 8.0, image: bestSeller.BS3, liked: true },
];
